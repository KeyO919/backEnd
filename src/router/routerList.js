...
const frametInside = [
    ...
    },
    {
        ...
        children: (pre => [
            { path: 'index', name: `${pre}index`, component: () => import('@/views/demo/components/index'), meta: { ...meta, title: '组件首页',requiresAuth:false } },
    ...
    },
    {
        ...
        children:[
            { path: 'index', name: 'page-index', component: () => import('@/views/pages/index'), meta: { ...meta, title: '组件首页',requiresAuth:false } },
        ]
    }
]
